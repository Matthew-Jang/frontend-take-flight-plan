<template>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-form ref="eventForm">
              ...
              <v-text-field v-model="event.event_type" label="Event Type" required></v-text-field>
              <v-text-field v-model="event.date" label="Date (YYYY-MM-DD)" required></v-text-field>
              <v-text-field v-model="event.start_time" label="Start Time (HH:MM:SS)" required></v-text-field>
              <v-text-field v-model="event.end_time" label="End Time (HH:MM:SS)" required></v-text-field>
              <v-text-field v-model="event.location" label="Location"></v-text-field>
            </v-form>
          </v-card-text>
          <v-card-actions>
  ...
  export default {
    ...
    methods: {
      ...
      openCreateDialog() {
        this.event = { event_id: null, name: "", description: "", event_type: "", date: "", start_time: "", end_time: "", location: "" };
        this.editMode = false;
        this.dialog = true;
      },
      editEvent(eventData) {
