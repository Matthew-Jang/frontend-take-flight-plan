  ...
  data() {
    return {
      user: {
        ...
        avatar: "",
        badges: [
          { name: "Early Bird", imageUrl: require('@/assets/images/badges/badge0.png') },
          { name: "The Worm", imageUrl: require('@/assets/images/badges/badge1.png') },
          { name: "OC Eagle", imageUrl: require('@/assets/images/badges/badge2.png') }
        ]
      }
    };
  },
